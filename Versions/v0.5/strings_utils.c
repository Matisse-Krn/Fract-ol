...
/*   Updated: 2025/02/07 13:19:29 by mkerrien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_max_iterations(t_fractal *fractal)
{
	...
	mlx_string_put(fractal->mlx_ptr, fractal->win_ptr, 5, 10, 0xFFFFFF,"Max iterations : ");
	mlx_string_put(fractal->mlx_ptr, fractal->win_ptr, 105, 10, 0xFFFFFF,max_iterations);
	free (max_iterations);
}
