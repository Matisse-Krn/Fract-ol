...
void	jump_menu(void)
{
	...
	ft_putstr_fd("\t[3] Elephant Valley     → x = 0.2847,  y = -0.0118\n", 1);
	ft_putstr_fd("\t[4] Triple Spiral       → x = -0.7477, y = 0.1002\n", 1);
	...
	ft_putstr_fd("\t[8] Near the End        → x = -1.9075, y = -0.0002\n", 1);
	ft_putstr_fd("\t[9] Antennae            → x = -0.1745,   y = 1.0206\n\n", 1);
